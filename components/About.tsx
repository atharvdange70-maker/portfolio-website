...
>
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute right-10 bottom-20 h-80 w-80 rounded-full bg-sky-500/10 blur-3xl" />
      </div>
  ...
  <div className="grid lg:grid-cols-2 gap-16 items-center">
    ...
    <motion.div
      ...
      className="max-w-4xl"
    >
          <span className="inline-flex items-center gap-2 rounded-full border border-cyan-500/30 bg-cyan-500/10 px-4 py-2 text-sm font-semibold uppercase tracking-[0.25em] text-cyan-300 backdrop-blur-md">
...
>
  {/* Gradient Border */}
  {/* Gradient Border */}
<div className="relative -translate-x-5 rounded-full bg-linear-to-r from-cyan-400 via-sky-500 to-blue-500 p-2">
              ...
              <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
                <div className="max-w-3xl">
                  ...
                  <p className="mt-5 text-lg leading-8 text-slate-300">
                    ...
                    solutions using modern DevOps tools and AWS services. Every
                    project is an opportunity to improve my skills and build
