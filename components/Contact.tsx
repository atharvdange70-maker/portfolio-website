...
export default function Contact() {
  return (
    <section
      id="contact"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-transparent text-white px-6 pt-10 pb-24"
    >
      <div className="max-w-7xl mx-auto w-full">
        ...
        {/* =====================================================
            BOTTOM CLICKABLE SOCIAL ICONS
        ====================================================== */}
        <div className="mt-10 pb-2 flex items-center justify-center gap-5">
