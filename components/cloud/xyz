          ...
          <div className="relative z-10 grid gap-10 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-5 max-w-xl leading-8 text-slate-400">
                I continuously improve my DevOps expertise by building
                real-world AWS projects, automating infrastructure with
                Terraform, deploying containerized applications using Docker and
                Kubernetes, and creating CI/CD pipelines with Jenkins while
